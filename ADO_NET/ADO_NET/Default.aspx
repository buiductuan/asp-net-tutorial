<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ADO_NET.Default" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="form-add">
           ...
           <asp:RadioButtonList runat="server" ID="rdlStatus">
            ...
            <asp:Button runat="server" ID="bntAdd" OnClick="bntAdd_Click" Text="Add new record" />
        </div>
        <ul>
